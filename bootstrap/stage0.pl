...
:-(xtl_to_pl_goal(A,B,C),','(=...(B,'.'(D,E)),','(length(E,F),','(;(','(xtlm_find(A,/(/(D,F),G),H),!),throw(not_found(/(D,F)))),','(maplist(xtl_to_pl_quoted(A),I,E,J),','(append(J,K),','(comma_list(L,K),','(=...(M,'.'(D,I)),;(','(=(L,'()'),=(C,M)),=(C,','(L,M))))))))))).
...
:-(xtl_to_pl_dcg(A,B,C,D,E),','(!,','(=...(B,'.'(F,G)),','(','(length(G,H),+(H,2,I)),;(','(xtlm_find(A,/(/(F,I),J),K),','(!,','(maplist(xtl_to_pl_quoted(A),L,G,M),','(append('.'(F,L),'.'(D,'.'(E,[])),N),','(=...(O,N),','(append(M,P),;(','(=(P,[]),','(!,=(C,O))),','(comma_list(Q,P),=(C,','(Q,O)))))))))),;(','(','(-(I,2,R),xtlm_find(A,/(/(F,R),S),T)),','(xtl_to_pl_goal(A,B,U),=(C,','(=(D,E),U)))),throw(not_found(/(F,I))))))))).
...
:-(xtl_to_pl_funexpr(A,B,C,D),','(compound(C),','(!,','(=...(C,'.'(E,F)),','(','(length(F,G),+(G,1,H)),','(;(','(xtlm_find(A,/(/(E,H),I),J),!),throw(not_found(/(E,H)))),','(maplist(xtl_to_pl_funexpr(A),K,F,L),','(append(L,M),','(append(K,'.'(B,[]),N),','(=...(O,'.'(E,N)),append(M,'.'(O,[]),D))))))))))).
...
:-(xtl_eval_funexpr(A,B,C),','(=...(B,'.'(D,E)),','(','(length(E,F),+(F,1,G)),','(;(xtlm_find(A,/(/(D,G),H),I),throw(error(not_found(/(D,G))))),','(maplist(xtl_eval_funexpr(A),E,J),','(append(J,'.'(C,[]),K),xtl_eval_call(A,I,K))))))).
...
:-(xtl_eval_goal(A,B),','(=...(B,'.'(C,D)),','(length(D,E),','(;(xtlm_find(A,/(/(C,E),F),G),throw(error(not_found(/(C,E))))),','(maplist(xtl_eval_quoted(A),D,H),xtl_eval_call(A,G,H)))))).
:-(xtl_eval_quoted(A,'`'(B),C),','(!,xtl_eval_funexpr(A,B,C))).
:-(xtl_eval_quoted(A,B,C),','(=...(B,'.'(D,E)),','(maplist(xtl_eval_quoted(A),E,F),=...(C,'.'(D,F))))).
...
:-(xtl_eval_dcg(A,B,C,D),','(=...(B,'.'(E,F)),','(','(length(F,G),+(G,2,H)),','(maplist(xtl_eval_quoted(A),F,I),;(','(xtlm_find(A,/(/(E,H),J),K),','(!,','(append(I,'.'(C,'.'(D,[])),L),xtl_eval_call(A,K,L)))),;(','(','(-(H,2,M),xtlm_find(A,/(/(E,M),N),K)),','(append(I,O),xtl_eval_call(A,K,O))),throw(error(not_found(/(E,H)))))))))).
:-(xtl_eval_call(A,prolog(/(B,C)),D),','(assert(length(D,C)),','(=...(E,'.'(B,D)),call(E)))).
