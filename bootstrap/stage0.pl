...
:-(pexpr(pexpr(A)),pexpr_raw(A)).
:-(pexpr(variable(A)),atom(A)).
:-(pexpr(name(A)),atom(A)).
:-(pexpr(apply(A,B)),','(pexpr(A),maplist(pexpr,B))).
:-(pexpr(number(A)),number(A)).
:-(pexpr_raw(A),;(number(A),;(atom(A),','(=..(A,'.'(B,C)),','(!,','(atom(B),maplist(pexpr_raw,C))))))).
:-(xtl_expression(A,B,C,D),','(assert(::(A,number)),','('__contract_free_xtl_expression'(A,B,C,D),assert(::(B,pexpr))))).
...
xtl_include_prelude(module(_, '.'(-(/(/(halt,1),'.'(pred,[])),prolog(/(halt,1))),'.'(-(/(/(halt,0),'.'(pred,[])),prolog(/(halt,0))),'.'(-(/(/(write,1),'.'(pred,[])),prolog(/(write,1))),'.'(-(/(/(nl,0),'.'(pred,[])),prolog(/(nl,0))),'.'(-(/(/(unify,2),'.'(fun,[])),define(unify,'.'(nondet,[]),'.'(:(_9298,_9298),[]))),'.'(-(/(/(+,3),'.'(fun,[])),define(+,'.'(nondet,[]),'.'(:(','(_13704,_13735),if(_13825,'prolog$'('.'(_13704,'.'(_13735,'.'(_13825,[]))),'[A,B,C]','C is A + B'))),[]))),'.'(-(/(/(-,3),'.'(fun,[])),define(-,'.'(nondet,[]),'.'(:(','(_18385,_18416),if(_18506,'prolog$'('.'(_18385,'.'(_18416,'.'(_18506,[]))),'[A,B,C]','C is A - B'))),[]))),_18826))))))), _)).