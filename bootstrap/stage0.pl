...
xtl_include_prelude(module(_, '.'(-(/(/(unify,2),'.'(fun,[])),define(unify,'.'(nondet,[]),'.'(:(_1732,_1732),[]))),'.'(-(/(/(+,3),'.'(fun,[])),define(+,'.'(nondet,[]),'.'(:(','(_5926,_5957),if(_6047,'prolog$'('.'(_5926,'.'(_5957,'.'(_6047,[]))),'[A,B,C]','C is A + B'))),[]))),'.'(-(/(/(-,3),'.'(fun,[])),define(-,'.'(nondet,[]),'.'(:(','(_10397,_10428),if(_10518,'prolog$'('.'(_10397,'.'(_10428,'.'(_10518,[]))),'[A,B,C]','C is A - B'))),[]))),_10838))), _)).