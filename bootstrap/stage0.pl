...
:-(pl_op(200,fy,+),true).
:-(pl_op(200,fy,-),true).
:-(xtl_include(A,B),','(t('Loading file:'(A)),','(read_file(A,C),','(!,xtl_top_level(B,C,[]))))).
